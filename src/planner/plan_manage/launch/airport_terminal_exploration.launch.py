"""Autonomous exploration in the Open-RMF Airport Terminal core map."""
...
def generate_launch_description():
    ...
    airport_pcd = os.path.join(scan_share, "maps", "airport_terminal_core.pcd")
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            "metrics_file", default_value="/tmp/airport_terminal_metrics.csv"),
        # RMF graph vertex junction_n20: a verified central navigation point
        # with approximately 4.8 m clearance from the nearest structural wall.
        DeclareLaunchArgument("init_x", default_value="8.54"),
        DeclareLaunchArgument("init_y", default_value="11.97"),
